//  now we access all data and data function from derive class
// now we access base1,base2,and derive all memeber function by derive class object
...
// now we access derive class memeber function from derive class object
    
    // derive ob2;
    // ob2.input2();
    // ob2.show2();

// now we access base1 and base2 class memeber function from derive class object
